...
function App() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          ...
          await axios.get(`https://api.openweathermap.org/geo/1.0/reverse?lat=${lat}&lon=${lon}&limit=5&appid=c1a34982c5333ac1d95f9e413adbe40b`)
          .then(response => {
  ...
  return (
    <>
      ...
      ) : (location == ''? <div className="loading-message">Loading location...</div>:
